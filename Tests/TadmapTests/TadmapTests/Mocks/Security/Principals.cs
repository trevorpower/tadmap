...
namespace TadmapTests.Mocks.Security
{
   internal class Principals
   {
      ...
      static public IPrincipal Guest
      {
         get
         {
            return new System.Security.Principal.GenericPrincipal(new GenericIdentity(string.Empty, string.Empty), NoRoles);
         }
      }
      ...
      static public IPrincipal Collector
      {
         get
         {
            return new System.Security.Principal.GenericPrincipal(new GenericIdentity(string.Empty, string.Empty), CollectorRole);
         }
      }
