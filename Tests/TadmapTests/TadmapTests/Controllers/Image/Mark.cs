...
namespace TadmapTests.Controllers.Image
{
   ...
   public class Mark
   {
      ...
      {
         ActionResult result = _imageController.Mark(new Guid("16b4d816-2e1e-4d54-9b66-78ef0fb7cbf2"), Principals.Administrator);
      }
      ...
      private void AssertThrowsException(Guid id, Type type, IPrincipal principal)
      {
         try
         {
            ActionResult result = _imageController.Mark(id, principal);
