...
namespace Amazon.EC2.Mock
{
    ...
    public  class AmazonEC2Mock : AmazonEC2 {
        ...
        {
            return Invoke<DescribeReservedInstancesResponse>("DescribeReservedInstancesResponse.xml");
        }
        ...
        {
            return Invoke<DescribeReservedInstancesOfferingsResponse>("DescribeReservedInstancesOfferingsResponse.xml");
        }
        ...
        {
            return Invoke<PurchaseReservedInstancesOfferingResponse>("PurchaseReservedInstancesOfferingResponse.xml");
        }
