...
namespace Amazon.EC2
{
    ...
    */
    public class AmazonEC2Client : AmazonEC2
    {
         ...
         */
        private IDictionary<String, String> ConvertDescribeReservedInstancesOfferings(DescribeReservedInstancesOfferingsRequest request)
        {
         ...
         */
        private IDictionary<String, String> ConvertDescribeReservedInstances(DescribeReservedInstancesRequest request)
        {
         ...
         */
        private IDictionary<String, String> ConvertPurchaseReservedInstancesOffering(PurchaseReservedInstancesOfferingRequest request)
        {
