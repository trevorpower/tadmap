...
using Tad.DataPortal.Server;
using Tad.Server;

namespace Tad.DataPortal.Client
{
    /// <summary>
    ...
    public static class DataPortal
    {
        ...
        private static object Create(Type objectType, object criteria)
        {
            ...
            catch (Server.DataPortalException ex)
            {
                ...
                throw new DataPortalException(
                  string.Format("DataPortal.Create {0} ({1})", "Failed", ex.InnerException.InnerException),
        ...
        private static object Fetch(Type objectType, object criteria)
        {
            ...
            catch (Server.DataPortalException ex)
            {
                ...
                if (ex.InnerException is CallMethodException)
                {
                ...
                throw new DataPortalException(
                  String.Format("DataPortal.Fetch {0} ({1})", "Failed", innerMessage),
                  ex.InnerException, result.ReturnObject);
            }
        ...
        public static object Update(object obj)
        {
            ...
            catch (Server.DataPortalException ex)
            {
                ...
                if (proxy.IsServerRemote)
                    ApplicationContext.SetGlobalContext(result.GlobalContext);
                throw new DataPortalException(
                  String.Format("DataPortal.Update {0} ({1})", "Failed", ex.InnerException.InnerException),
                  ex.InnerException, result.ReturnObject);
            }
        ...
        public static void Delete(object criteria)
        {
            ...
            catch (Server.DataPortalException ex)
            {
                ...
                if (proxy.IsServerRemote)
                    ApplicationContext.SetGlobalContext(result.GlobalContext);
                throw new DataPortalException(
                  String.Format("DataPortal.Delete {0} ({1})", "Failed", ex.InnerException.InnerException),
                  ex.InnerException, result.ReturnObject);
            }
        ...
        private static IDataPortalProxy GetDataPortalProxy(bool forceLocal)
        {
            if (forceLocal)
            {
                if (_localPortal == null)
                    _localPortal = new LocalProxy();
                return _localPortal;
            }
            else
            {
