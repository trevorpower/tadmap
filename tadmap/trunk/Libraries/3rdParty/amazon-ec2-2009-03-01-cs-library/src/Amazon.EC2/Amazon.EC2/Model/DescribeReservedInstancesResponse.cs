...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeReservedInstancesResponse
    {
        ...
        /// </summary>
        /// <param name="describeReservedInstancesResult">DescribeReservedInstancesResult property</param>
        /// <returns>this instance</returns>
        ...
        public Boolean IsSetDescribeReservedInstancesResult()
        {
        ...
        public String ToXML() {
            ...
            xml.Append("<DescribeReservedInstancesResponse xmlns=\"http://ec2.amazonaws.com/doc/2009-03-01/\">");
            ...
            if (IsSetDescribeReservedInstancesResult()) {
                DescribeReservedInstancesResult  describeReservedInstancesResult = this.DescribeReservedInstancesResult;
                xml.Append("<DescribeReservedInstancesResult>");
                xml.Append(describeReservedInstancesResult.ToXMLFragment());
                xml.Append("</DescribeReservedInstancesResult>");
            } 
            xml.Append("</DescribeReservedInstancesResponse>");
            return xml.ToString();
        }
