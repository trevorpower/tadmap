<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Default.aspx.cs"
   Inherits="_Default" Title="tadmap" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="Server">
   ...
   <div runat="server" id="divMapList" style="padding: 10px 30px 10px 30px;">
      <div style="border: none; margin: 5px; float: left; padding: 5px; height: 80px;
         width: 300px; background: #EEFFEE;">
      ...
      <asp:Repeater ID="m_repMapRepeater" runat="server">
         <ItemTemplate>
            <div runat="server" id="ListItem" style="border: dotted 1px #EEEEEE; margin: 5px; float: left; padding: 5px; height: 80px;
               ...
               <asp:Label runat="server" ID="m_lblDescription"></asp:Label>
            </div>
         </ItemTemplate>
      </asp:Repeater>
   </div>
